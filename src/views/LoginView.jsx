  ...
  return (
    <CardView>
      ...
      <button
        ...
        class="flex items-center gap-3 bg-blue-600 rounded-full p-0.5 pr-4 transition-colors duration-300 hover:bg-google-button-blue-hover w-full md:w-1/2 mx-auto"
        onClick={handleLogin}
      >
